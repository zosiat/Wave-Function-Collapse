...
function setup() {
  ...
  //4 values are for the different sides [top, right, bottom, left] (i think)
   tiles[0] = new Tile(tileImages[0], ['AAA', 'AAA', 'AAA', 'AAA']);
   tiles[1] = new Tile(tileImages[1], ['ABA', 'ABA', 'ABA', 'AAA']);
   tiles[2] = new Tile(tileImages[2], ['ABA', 'ABA', 'AAA', 'AAA']);
   tiles[3] = new Tile(tileImages[3], ['AAA', 'AAA', 'ABA', 'AAA']);
